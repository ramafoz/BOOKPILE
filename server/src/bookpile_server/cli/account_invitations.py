"""Create or revoke temporary beta account invitations from a trusted host."""
...
from ..services.account_invitations import AccountInvitationError, AccountInvitationService
