...
const data = {
  ...
  layout: {
    ...
    bookcases: [{ bookcase_id: "case", x_mm: 200, floor_y_mm: 1600, width_mm: 800, height_mm: 1200, shelf_direction: "TOP_TO_BOTTOM", homogeneous_structure: true, frame_left_mm: 20, frame_right_mm: 20, top_closure_mm: 30, bottom_closure_mm: 30, separator_thickness_mm: 20 }],
    shelves: [{ shelf_id: "shelf", height_weight: 1, x_mm: 20, floor_y_mm: 30, width_mm: 760, height_mm: 1140, alignment: "CENTER", offset_mm: 0, width_source: "DERIVED", height_source: "DERIVED", open_top: false, left_frame_mm: 20, right_frame_mm: 20, top_closure_mm: 30, bottom_board_mm: 30, separator_after_mm: null, separator_anchor: "BOTTOM", separator_height_mm: null, separator_source: null }],
